...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://quentinha.exodoti.xyz/">Home</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="http://quentinha.exodoti.xyz/Home/SobreNos">Sobre Nós</a></li>
            <li><a href="http://quentinha.exodoti.xyz/Usuario/listar">Usuários</a></li>
        ...
        <li><a href="#"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Relatórios</a></li>
      </ul>
